 ...
 *
 * @param {object} props
 * @param {'primary' | 'secondary' | 'danger' | 'simple' | 'note' | 'none'} [props.variant] - Visual style of the button
...
const Button = ({
  ...
  const baseStyles =
    "py-2 px-4 font-medium focus:outline-none focus:ring-1 transition-colors cursor-pointer rounded disabled:opacity-50 disabled:cursor-not-allowed";
